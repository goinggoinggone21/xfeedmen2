...
#Load Reddits
reddits_with_redgif = helper.get_reddit_redgifs('MikeAdriano', time_period='month')
reddits_with_redgif = reddits_with_redgif + helper.get_reddit_redgifs('MikeAdriano', time_period='year')
reddits_with_redgif = reddits_with_redgif + helper.get_reddit_redgifs('MikeAdriano', time_period='all')
