...
#Load Reddits
reddits_with_redgif, all_urls_ever = helper.load_reddits(subreddit_input='AngelaWhite', 
...
try:
	...
	for reddit_submission in reddits_with_redgif:
		...
		if (str(submission_url) not in all_urls_ever):
			...
			continue
	tweet_title_final = helper.create_caption_non_MA(long_name='Angela White',short_name='Angie') #random.choice(helper.imojis_list)*3 #get_tweet_title(submission_title) 
